        ...
        <main className="dashboard-container">
            ...
            <header className="dashboard-header">
                <div className="header-left">
                    <Link href="/" className="back-btn">
                        <img src="/logo.png" alt="ASC Logo" style={{ height: '24px', marginRight: '12px' }} onError={(e) => e.currentTarget.style.display = 'none'} />
                        <ArrowLeft size={20} />
                    </Link>
                    <h1>예약 현황</h1>
                </div>
            ...
            <section className="card calendar-card">
                <div className="calendar-header">
                    ...
                    <button onClick={prevMonth} className="nav-btn hidden"><ChevronLeft size={20} /></button> {/* Spacer */}
                ...
                <div className="calendar-grid">
                    ...
                    {calendarDays.map((item, idx) => {
                        ...
                        const isFull = item.stats.available === 0;
                        const isHoliday = false; // TODO: Utils integration for color
                        const dayOfWeek = new Date(item.dateStr).getDay();
                        const isRed = dayOfWeek === 0;
                        ...
                        return (
                            ...
                            >
                                <span className={`day-num ${isRed ? "sun" : isBlue ? "sat" : ""}`}>{item.day}</span>
            ...
            <section className="stats-row">
                ...
                <div className="stat-card">
                    ...
                    <div className="stat-value text-orange">0</div>
                    <Clock className="stat-icon text-orange" />
                </div>
                <div className="stat-card">
            ...
            <section className="card daily-detail-card">
                ...
                <div className="legend">
                    ...
                    <span className="legend-item"><span className="dot wait"></span> 승인 대기</span>
            ...
            <section className="recent-list-section">
                ...
                {/* Could add a list here if needed, keeping it minimal for now as per screenshot focus */}
